...
import {getHoursMinutsStamp, getYearMonthDayStamp, getDurationTemplate, getSortDatesEndDaysForTemplate} from "../date-utils.js";
...
export default class DayItem {
  ...
  getTemplate() {
    return createDayItem(this._events, 0);
  }
